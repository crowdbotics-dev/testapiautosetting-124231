...
## Project Structure
    ...
    ├── testapiautosetting_124231  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124231`
...
2. Clone this repo and `cd testapiautosetting_124231`
